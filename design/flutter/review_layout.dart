          ...
          Expanded(
            child: Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                SrsBoardWithCoordinates(size: b, outside: true, board: board(context, b, true)),
        ...
        Expanded(
          child: Padding(
            ...
            child: Column(children: [
              Center(
                child: SrsBoardWithCoordinates(size: b, outside: false, board: board(context, b, false)),
              ),
              Expanded(
                child: Padding(
...
class SrsReviewSide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(padding: EdgeInsets.only(top: wide ? 2 : 0), child: meta),
      SizedBox(height: wide ? 22 : 8),
      ConstrainedBox(constraints: BoxConstraints(minHeight: lineH * 2), child: line),
      Expanded(
        child: wide
            ? Padding(padding: const EdgeInsets.only(top: 26), child: SingleChildScrollView(child: slot))
            : _BottomFade(child: Padding(padding: const EdgeInsets.only(top: 10, bottom: 22), child: SingleChildScrollView(child: slot))),
      ),
      ConstrainedBox(constraints: const BoxConstraints(minHeight: 56), child: Padding(padding: const EdgeInsets.fromLTRB(0, 6, 0, 4), child: actions)),
    ]);
  }
}
