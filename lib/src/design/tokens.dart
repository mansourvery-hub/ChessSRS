...
abstract final class SrsLayout {
  ...
  static const EdgeInsets reviewPaddingNarrow =
      EdgeInsets.fromLTRB(12, 0, 12, 6);
  static const EdgeInsets reviewPaddingWide =
      EdgeInsets.fromLTRB(28, 0, 34, 28);
  ...
  static double boardSize(Size content) {
    if (isWide(content.width)) {
      return math.max(
        0,
        math.min(content.height - 64, content.width - 480),
      );
    }
    return math.max(
      0,
      math.min(content.width - 24, content.height - 222),
    );
  }
}
...
abstract final class SrsText {
  ...
  static TextStyle scopeName(Color c) =>
      _ui(17, FontWeight.w600, c, em: -0.015, height: 1.2);
  ...
  static TextStyle rowName(Color c) =>
      _ui(15.5, FontWeight.w500, c, em: -0.005);
  ...
  static TextStyle settingHelp(Color c) =>
      _ui(14, FontWeight.w400, c, height: 1.4);

  /// Notation line size.
  static double lineSize({required bool wide, double wideWidth = 0}) =>
      wide ? (wideWidth * 0.024).clamp(23.0, 31.0) : 21;
  static TextStyle lineMove(double size, Color c) => _ui(
        size,
        FontWeight.w600,
        c,
        em: -0.012,
        height: _wideLineHeight(size),
        tab: true,
      );
  static TextStyle lineNumber(double size, Color c) => _ui(
        size,
        FontWeight.w400,
        c,
        em: -0.012,
  ...
  static TextStyle answerHelp(bool wide, Color c) =>
      _ui(wide ? 16 : 15, FontWeight.w400, c);
  ...
  static TextStyle title(Color c) =>
      _ui(32, FontWeight.w400, c, em: -0.02, height: 1.15);
  static TextStyle titleSmall(Color c) =>
      _ui(24, FontWeight.w500, c, em: -0.015, height: 1.2);
